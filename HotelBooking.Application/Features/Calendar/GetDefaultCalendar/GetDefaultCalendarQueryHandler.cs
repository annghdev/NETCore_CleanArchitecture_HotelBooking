...
public class GetDefaultCalendarQueryHandler : IRequestHandler<GetDefaultCalendarQuery, DefaultCalendar>
{
    private readonly IRoomRepository _roomRepository;
    private readonly IBookingRepository _bookingRepository;

    public GetDefaultCalendarQueryHandler(
    ...
    public async Task<DefaultCalendar> Handle(GetDefaultCalendarQuery request, CancellationToken cancellationToken)
    {
