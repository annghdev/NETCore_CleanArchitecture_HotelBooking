...
public class GetDateRangeCalendarQueryHandler : IRequestHandler<GetDateRangeCalendarQuery, DateRangeCalendarMatrix>
{
    ...
    public async Task<DateRangeCalendarMatrix> Handle(GetDateRangeCalendarQuery request, CancellationToken cancellationToken)
    {
        ...
        return new DateRangeCalendarMatrix
        {
            RoomId = room.Id,
            RoomName = room.Name,
            From = vietnamFrom,
